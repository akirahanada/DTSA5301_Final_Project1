...
### 5.2 Difference amaong boroughs
...
- After 2012, there was a decrease and then a increase in 2020.
...
The figure below shows the Prophet model predicting the number of incidents based on months. It shows a decreasing trend in the future. This trend is increasing in the long term, but it is expected to be affected by seasonal fluctuations.
